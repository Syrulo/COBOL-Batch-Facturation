*> ==========================================================
*> SOUS-PROGRAMME : PDATESTR
*> Objectif : Convertir une date YYYY-MM-DD en texte complet
*> Entrée : LS-IN-DATE (X(10))
*> Sortie : LS-OUT-DATE-TEXT (X(20))
*> Remarques : Utilisé par le programme PEXTRACT pour générer
*>             des factures avec la date en toutes lettres
*> ==========================================================
